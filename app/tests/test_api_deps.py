...
from app.api.dependencies.redis import _get_redis_client, get_cache_service
from app.api.dependencies.users import _get_repository, _get_unit_of_work
...
def test_get_redis_client_returns_client_from_app_state() -> None:
    ...
    result = _get_redis_client(request)
...
def test_get_cache_service_builds_cache_with_redis_client() -> None:
    ...
    service = get_cache_service(redis_client)
...
def test_user_dependencies_create_expected_instances() -> None:
    ...
    unit_of_work = _get_unit_of_work(session)
