...
async def test_create_user_invalidates_list_cache() -> None:
    repository = make_repository()
    cache = make_cache()
    user = make_user()
...
async def test_update_user_invalidates_detail_and_list_cache() -> None:
    repository = make_repository()
    cache = make_cache()
    user = make_user()
...
async def test_delete_user_invalidates_detail_and_list_cache() -> None:
    repository = make_repository()
    cache = make_cache()
    user = make_user()
    user.active = False
